...
EmailValidator = RegexValidator(re.compile(r'((?:[-!#$%&\'*+/=?^`{|}~\w]|\\.)+(?:\.(?:[-!#$%&\'*+/=?^`{|}~\w]|\\.)+)*|'
                                           r'"(?:[^\\"]|\\.)+")@(?:\[(?:((?:(?:[01][\d]{0,2}|2(?:[0-4]\d?|5[0-5]?|[6-9]'
                                           r')?|[3-9]\d?)\.){3}(?:[01][\d]{0,2}|2(?:[0-4]\d?|5[0-5]?|[6-9])[a-fA-F0-9]{'
                                           r'1,4}:){5}:(?:[a-fA-F0-9]{1,4}:)?[a-fA-F0-9]{1,4}|(?:[a-fA-F0-9]{1,4}:){4}:'
                                           r'(?:[a-fA-F0-9]{1,4}:){0,2}[a-fA-F0-9]{1,4}|(?:[a-fA-F0-9]{1,4}:){3}:(?:[a-'
                                           r'fA-F0-9]{1,4}:){0,3}[a-fA-F0-9]{1,4}|(?:[a-fA-F0-9]{1,4}:){2}:(?:[a-fA-F0-'
                                           r'9]{1,4}:){0,4}[a-fA-F0-9]{1,4}|[a-fA-F0-9]{1,4}::(?:[a-fA-F0-9]{1,4}:){0,5'
                                           r'}[a-fA-F0-9]{1,4}|::(?:[a-fA-F0-9]{1,4}:){0,6}[a-fA-F0-9]{1,4}|(?:[a-fA-F0'
                                           r'-9]{1,4}:){1,7}:|(?:[a-fA-F0-9]{1,4}:){6}(?:(?:[01][\d]{0,2}|2(?:[0-4]\d?|'
                                           r'5[0-5]?|[6-9])?|[3-9]\d?)\.){3}(?:[01][\d]{0,2}|2(?:[0-4]\d?|5[0-5]?|[6-9]'
                                           r')?|[3-9]\d?)|(?:[a-fA-F0-9]{1,4}:){0,5}:(?:(?:[01][\d]{0,2}|2(?:[0-4]\d?|5'
                                           r'[0-5]?|[6-9])?|[3-9]\d?)\.){3}(?:[01][\d]{0,2}|2(?:[0-4]\d?|5[0-5]?|[6-9])'
                                           r'?|[3-9]\d?)|::(?:[a-fA-F0-9]{1,4}:){0,5}(?:(?:[01][\d]{0,2}|2(?:[0-4]\d?|5'
                                           r'[0-5]?|[6-9])?|[3-9]\d?)\.){3}(?:[01][\d]{0,2}|2(?:[0-4]\d?|5[0-5]?|[6-9])'
                                           r'?|[3-9]\d?))|([-a-zA-Z0-9]{0,62}[a-zA-Z0-9]:[^\[\\\]]+))\]|([a-zA-Z0-9](?:'
                                           r'[-a-zA-Z0-9]{0,62}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[-a-zA-Z0-9]{0,62}[a-zA-'
                                           r'Z0-9])?)+))'))
URLValidator = RegexValidator(re.compile(r'(?:(?i:http|ftp)s?://)(?:\S+(?::\S*)?@)?(?:(?:[01]\d\d|2(?:[0-4]\d|5[0-5]))('
                                         r'?:\.(?:[01]\d\d|2(?:[0-4]\d|5[0-5])){3}|(?:(?:(?:(?:[a-fA-F0-9]){1,4}:){1,4}'
                                         r':[^\s:](?:(?:25[0-5]|(?:2[0-4]|1?\d)?\d\.){3}25[0-5]|(?:2[0-4]|1?\d)?\d))|(?'
                                         r':::(?:[Ff]{4}(?::0{1,4})?:)?[^\s:](?:(?:25[0-5]|(?:2[0-4]|1?\d)?\d\.){3}25[0'
                                         r'-5]|(?:2[0-4]|1?\d)?\d))|(?:[Ff][Ee]80:(?::(?:[a-fA-F0-9]){1,4}){0,4}%[a-zA-'
                                         r'Z0-9]+)|(?::(?:(?::(?:[a-fA-F0-9]){1,4}){1,7}|:))|(?:(?:[a-fA-F0-9]){1,4}:(?'
                                         r':(?::(?:[a-fA-F0-9]){1,4}){1,6}))|(?:(?:(?:[a-fA-F0-9]){1,4}:){1,2}(?::(?:[a'
                                         r'-fA-F0-9]){1,4}){1,5})|(?:(?:(?:[a-fA-F0-9]){1,4}:){1,3}(?::(?:[a-fA-F0-9]){'
                                         r'1,4}){1,4})|(?:(?:(?:[a-fA-F0-9]){1,4}:){1,4}(?::(?:[a-fA-F0-9]){1,4}){1,3})'
                                         r'|(?:(?:(?:[a-fA-F0-9]){1,4}:){1,5}(?::(?:[a-fA-F0-9]){1,4}){1,2})|(?:(?:(?:['
                                         r'a-fA-F0-9]){1,4}:){1,6}:(?:[a-fA-F0-9]){1,4})|(?:(?:(?:[a-fA-F0-9]){1,4}:){1'
                                         r',7}:)|(?:(?:(?:[a-fA-F0-9]){1,4}:){7,7}(?:[a-fA-F0-9]){1,4}))|(?:[a-zA-Z\u00'
                                         r'a1-\uffff0-9]+)(?:\.[a-zA-Z\u00a1-\uffff0-9]+)+)|localhost)(?::\d{1,5})?(?:/'
                                         r'.*)?'))
